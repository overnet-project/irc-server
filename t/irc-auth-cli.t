...
like $output, qr/overnet-irc-auth\.pl\ bridge\ \[options\]/mx,
  'usage includes bridge mode';
like $output, qr/--line\ IRC_NOTICE_LINE/mx,
  'usage documents explicit single-line bridge mode';
like $output, qr/stdin/imx,
  'usage documents continuous stdin bridge mode';
like $output, qr/SASL/imx,
  'usage documents SASL bridge support';
like $output, qr/AUTHENTICATE/mx,
